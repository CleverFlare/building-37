        ...
        >
          <div className="flex flex-col gap-1">
            <h4 id={labelId} className="leading-none font-medium">
              {filters.length > 0 ? "فلاتر" : "لا يوجد فلاتر منفذة"}
            </h4>
            <p
              id={descriptionId}
              className={cn(
            ...
            >
              {filters.length > 0
                ? "عدّل الفلاتر لتنقية صفوفك."
                : "أضف فلاتر لتنقية صفوفك."}
            </p>
          </div>
          {filters.length > 0 ? (
...
interface DataTableFilterItemProps<TData> {
  ...
  setJoinOperator: (value: JoinOperator["value"]) => void;
    ...
    <SortableItem value={filter.filterId} asChild>
      ...
      >
        <div className="min-w-[72px] text-center">
          {index === 0 ? (
            <span className="text-muted-foreground text-sm">حيث</span>
          ) : index === 1 ? (
            <Select
              value={joinOperator}
              onValueChange={(value: JoinOperator["value"]) =>
            ...
            <span className="text-muted-foreground text-sm">
              {
                dataTableConfig.joinOperators.find(
                  (operator) => operator.value === joinOperator,
                )?.label
              }
            </span>
          )}
        ...
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
          ...
          >
            <Command>
              <CommandInput placeholder="بحث عن حقول..." />
              <CommandList>
